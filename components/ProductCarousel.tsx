      ...
      <div className="mb-5 flex items-end justify-between gap-4">
        ...
        <div className="hidden sm:flex items-center gap-2 flex-shrink-0">
          <button
            ...
            className="w-10 h-10 rounded-full border border-accent/25 bg-surfaceAlt/70 text-textBase flex items-center justify-center transition-colors hover:border-primary/50 hover:text-primary disabled:opacity-35 disabled:pointer-events-none"
          >
