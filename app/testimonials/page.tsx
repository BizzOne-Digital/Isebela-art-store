        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              ...
              >
                <span className="absolute top-4 left-4 text-accent text-2xl opacity-50">&#8220;</span>
                <div className="flex items-center gap-3 mb-4 relative z-10">
                  ...
                  <div>
                    ...
                    <p className="text-textBase/50 text-xs font-sans">{testimonial.location} · {testimonial.role}</p>
                  </div>
                </div>
