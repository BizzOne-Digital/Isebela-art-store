...
import { Mail, Phone, MapPin, MessageSquare, Send, Sparkles, AlertCircle, CheckCircle2 } from 'lucide-react';
        ...
        >
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            >
              ...
              <h2 className="text-2xl font-serif text-textBase mb-6 relative z-10">Envía tu Consulta</h2>
              ...
              {status === 'success' ? (
                ...
                >
                  ...
                  <h3 className="text-xl font-serif text-textBase mb-2">¡Mensaje Enviado!</h3>
                ...
                >
                  ...
                  <h3 className="text-xl font-serif text-textBase mb-2">Error al enviar</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {[
              ...
              >
                ...
                <h3 className="font-serif text-textBase mb-2">{item.title}</h3>
